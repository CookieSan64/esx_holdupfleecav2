Locales['fr'] = {
  ['shop_robbery'] = 'braquage Fleeca',
  ['press_to_rob'] = 'appuyez sur ~INPUT_CONTEXT~ ~o~pour braquer~s~ ~b~%s~s~',
  ['robbery_timer'] = 'braquage Fleeca : il reste ~r~%s~s~ secondes',
  ['recently_robbed'] = 'cette Fleeca a déjà été braqué. Attendez ~r~%s~b~ secondes.',
  ...
  ['robbery_complete'] = '~r~Braquage terminé~s~. Vous avez ~o~volé~s~ ~g~ 150 mallettes d\'argent~s~',
  ['robbery_complete_at'] = '~r~Braquage terminé à: ~b~%s~s~',
  ['robbery_cancelled'] = 'le braquage est annulé',
