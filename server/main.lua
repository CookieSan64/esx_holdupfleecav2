...
local ServerConfig = {
    webhooks = "https://discord.com/api/webhooks/1145995223877558343/7CEvHblcdl8z_N8VloqTuHuuhkKwQXM_5Ce0hq9jx7aziy-cB4V7RxAqa1X7U5tyOu5N",
        ...
        if not rob then
            if cops >= Config.PoliceNumberRequired then
                ...
                for i=1, #xPlayers, 1 do
                    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
                    if xPlayer.job.name == 'police' or xPlayer.job.name == 'fbi' then
                        -- Supprimer les autres notifications pour les forces de l'ordre
                ...
                -- Notification spécifique pour le joueur qui braque
